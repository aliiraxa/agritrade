                            ...
                            <form role="form" class="col-lg-7" action="" method="post">
                                 <span style="color:red; font-size:16px;"><?php
                                     ...
                                     ?>
                                        ...
                                        <button type="submit" name="update" class="btn btn-primary"><i class="fa fa-sign-out fa-fw"></i> Save</button>
                                        <a href="orders.php" class="btn btn-danger"><i class="fa fa-remove" aria-hidden="true"></i> Cancel</a>

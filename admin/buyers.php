                        ...
                        <div class="panel-body">
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tr class="odd gradeX">
                                    ...
                                    <td class="center"  style="text-align: center;">  <a class="btn btn-danger" onclick="return confirm('Are you sour to delete!')" href="buyers.php?delUser=<?php echo $result['user_id']; ?>"><i class="fa fa-remove"></i> Delete</a></td>
                                </tr>
                                     <?php }} ?>
                                </tbody>
                            </table>
